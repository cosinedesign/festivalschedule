...
import { eventService as services } from '../client/lib/client/services/festival.services.events';
import { utilities } from '../client/lib/client/services/festival.services.utilities';

describe('flybrarian tests', function () {
	...
	test('Sunday events', function () {
		...
		*/
		...
		const model = services.lineups.byDay(day, stages, { filter: fitEventWindow({			
				start: today,
				end: endTime		
			}) 
		});        
