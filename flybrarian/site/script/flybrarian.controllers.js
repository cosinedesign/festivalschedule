        ...
        home: {
            ...
            fomoVision: function () {
                try {
                    ...
                    const today = (festival.config.FOMO_TEST_DAY) ?  d(festival.config.FOMO_TEST_DAY, festival.config.FOMO_TEST_HOUR, festival.config.FOMO_TEST_MINUTES) : new Date(Date.now());
                    today.setSeconds(0);
